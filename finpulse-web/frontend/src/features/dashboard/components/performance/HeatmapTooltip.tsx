  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5 text-[11px]">
        ...
        <div className="flex justify-between text-slate-300"><span>Profit/Loss:</span><span className={point.profitLoss >= 0 ? "text-emerald-400 font-bold" : "text-rose-400 font-bold"}>{point.profitLoss >= 0 ? "+" : "-"}{formatMoney(Math.abs(point.profitLoss), user?.currency)}</span></div>
