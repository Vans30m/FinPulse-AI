...
export default function AiPerformanceCoachSection() {
  ...
  return (
    <section className="bg-[#121a2a]/45 border border-slate-900 rounded-3xl p-5 shadow-md relative overflow-hidden">
      <div className="absolute top-0 right-0 w-56 h-56 bg-cyan-500/5 blur-3xl pointer-events-none rounded-full" />

      <div className="flex items-center justify-between gap-4 mb-4 border-b border-slate-900 pb-4">
        <div>
          <h3 className="text-lg font-black text-white tracking-tight uppercase">AI Performance Coach</h3>
          <p className="text-xs text-slate-400 font-medium mt-1">AI-guided diagnostics, benchmark intelligence, and optimization actions for sustained performance quality.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-slate-900 bg-[#050711]/70 p-10 text-center">
          <p className="text-sm font-bold text-slate-300">No AI performance data available.</p>
          <button
            type="button"
            onClick={() => {
              setLoading(true);
        ...
        <>
            ...
            <div className="rounded-3xl border border-slate-900 bg-[#050711]/70 p-4">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="rounded-2xl border border-slate-900 bg-[#050711]/85 p-3">
                  ...
                  <p className="text-xs text-slate-300 mt-1.5 leading-relaxed">{data.concentrationRisk}</p>
                </div>
                <div className="rounded-2xl border border-slate-900 bg-[#050711]/85 p-3">
                  <p className="text-[10px] text-slate-500 font-extrabold uppercase tracking-wider">Risk Observation</p>
                  <p className="text-xs text-slate-300 mt-1.5 leading-relaxed">{data.riskObservation}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="rounded-2xl border border-slate-900 bg-[#050711]/70 p-4">
              <div className="flex items-center gap-2 mb-3 border-b border-slate-900 pb-3">
                ...
                <span className="text-xs font-black uppercase tracking-wider text-slate-400">Benchmark Analysis</span>
              </div>
              ...
              <div className="space-y-2.5">
                {data.benchmarkRows.map((row) => (
                  <div key={row.index} className="rounded-xl border border-slate-900 bg-[#050711]/85 p-3 flex items-center justify-between">
                    <div>
                      <p className="text-xs font-black text-white">{row.index}</p>
            ...
            <div className="rounded-2xl border border-slate-900 bg-[#050711]/70 p-4">
              <div className="flex items-center gap-2 mb-3 border-b border-slate-900 pb-3">
                ...
                <span className="text-xs font-black uppercase tracking-wider text-slate-400">Forecast & AI Signals</span>
              </div>
                ...
                {data.forecast.map((item) => (
                  <div key={item.horizon} className="rounded-xl border border-slate-900 bg-[#050711]/85 p-3">
                    <div className="flex items-center justify-between gap-2">
                      <p className="text-xs font-black text-white">{item.horizon}</p>
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-[11px]">
                <div className="rounded-xl border border-slate-900 bg-[#050711]/85 p-3 text-slate-300">
                ...
                <div className="rounded-xl border border-slate-900 bg-[#050711]/85 p-3 text-slate-300 sm:col-span-2">
          ...
          <div className="mt-4 rounded-2xl border border-slate-900 bg-[#050711]/70 p-4">
            <div className="flex items-center gap-2 mb-3 border-b border-slate-900 pb-3">
              ...
              <span className="text-xs font-black uppercase tracking-wider text-slate-400">AI Action Center</span>
            </div>
              ...
              {actions.map((action) => {
                ...
                return (
                  <button
                    ...
                    className="rounded-xl border border-slate-900 bg-[#050711]/85 px-3 py-2.5 text-xs font-black uppercase tracking-wider text-slate-300 hover:text-white hover:bg-slate-900 transition-colors inline-flex items-center justify-center gap-1.5"
                  >
