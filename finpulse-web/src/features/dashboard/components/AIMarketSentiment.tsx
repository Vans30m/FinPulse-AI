    ...
    <div className="rounded-3xl border border-slate-200/80 bg-white p-4 sm:p-8 dark:border-white/10 dark:bg-gradient-to-br dark:from-night-900 dark:via-night-950 dark:to-night-900 shadow-2xl relative overflow-hidden transition-all duration-300">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 border-b border-slate-100 dark:border-white/5 pb-4 sm:pb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            onClick={() => fetchBrief(true)}
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-white/[0.02] text-slate-600 hover:text-slate-950 dark:text-slate-300 dark:hover:text-white text-[10px] sm:text-xs font-black uppercase tracking-wider transition-all hover:scale-[1.02] active:scale-[0.98]"
      ...
      <div className="relative z-10 mt-5 sm:mt-8 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col gap-3 sm:gap-4">
          ...
          <div className="flex-1 rounded-2xl border border-slate-200/50 dark:border-white/5 bg-slate-50/30 p-3.5 sm:p-5 dark:bg-white/[0.01] shadow-sm flex items-center justify-between hover:border-slate-300 dark:hover:border-white/10 transition-all">
            ...
            <div className={`rounded-full px-3 py-1 text-[10px] sm:text-xs font-black uppercase tracking-widest border ${
      ...
      <div className="relative z-10 mt-5 sm:mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          {brief.insights.map((item: string, index: number) => (
            <div
              key={index}
              className="flex flex-col gap-3 rounded-2xl border border-slate-200/60 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.03] p-3.5 sm:p-5 hover:bg-slate-100/80 dark:hover:bg-white/[0.06] shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-white/10 transition-all duration-300 hover:-translate-y-0.5"
            >
              ...
              <p className="text-xs sm:text-sm font-semibold text-slate-800 dark:text-slate-200 leading-relaxed">{item}</p>
            </div>
          ))}
        </div>
      </div>
