        ...
        <div className="space-y-6 animate-fadeIn relative">
          ...
          <div className="inline-flex flex-wrap items-center gap-1.5 bg-slate-100/70 dark:bg-white/[0.02] backdrop-blur-md p-1.5 rounded-full border border-slate-200/50 dark:border-white/5 shadow-inner mt-2 w-full sm:w-auto">
            {[
              ...
              { id: 'screener-shareholding', label: 'Shareholding', tab: 'shareholding' },
              { id: 'screener-documents', label: 'Documents', tab: 'documents' },
            ].map((tab) => (
              <button
                key={tab.tab}
                onClick={() => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white/70 dark:bg-night-900/60 backdrop-blur-md border border-slate-200/50 dark:border-white/5 rounded-3xl p-6 shadow-xl hover:-translate-y-0.5 transition-all duration-300 space-y-4">
                ...
                <div className="pt-2.5 border-t border-slate-100 dark:border-white/5">
                  ...
                  <ul className="space-y-2 text-xs text-slate-500 dark:text-slate-400 font-medium mb-3">
                    <li className="flex items-center gap-2">
                      <span className="h-1 w-1 rounded-full bg-blue-500" />
                    </li>
                  </ul>
                  <div className="flex flex-wrap items-center gap-2 pt-2.5 border-t border-slate-100 dark:border-white/5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-white/5 pb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col items-center">
                  <button className="flex items-center gap-1.5 px-3.5 py-1.5 border border-purple-500/30 bg-purple-500/10 hover:bg-purple-500/25 text-purple-600 dark:text-purple-400 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all">
                    Trades
                  </button>
                  <span className="text-[9px] text-purple-500 dark:text-purple-400 mt-1 font-bold animate-pulse">2 Recently</span>
                </div>
              </div>
            </div>
